"""Tests for fused read-modify-write ops (M3.5).
...
def _fb(x: float) -> bytes:
    x = float(x)
    if x == 0.0:  # +0.0 / -0.0 collapse is a documented policy exception
        x = 0.0
...
# ==========================================================================
# Emission-path agreement (7.6) and marshal round-trip for fused programs.
# ==========================================================================
