...
class Interpreter:
    ...
    def run(self, node: EngineNode) -> float:
        ...
        match func:
            ...
            # Fused read-modify-write ops; evaluation-order semantics are documented on the _set_rmw* helpers.
            case Op.SetAdd:
            ...
            case Op.Judge:
                ...
                return _judge(source - target, perfect_min, perfect_max, great_min, great_max, good_min, good_max)
            case Op.JudgeSimple:
