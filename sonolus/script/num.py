...
if TYPE_CHECKING:
    ...
    @runtime_checkable
    class Num[T](Protocol):
        __match_args__ = ("real",)

        def __add__(self, other: T, /) -> Num[Num]: ...
        def __sub__(self, other: T, /) -> Num[Num]: ...
        def __mul__(self, other: T, /) -> Num[Num]: ...
        def __truediv__(self, other: T, /) -> Num[Num]: ...
        def __floordiv__(self, other: T, /) -> Num[Num]: ...
        def __mod__(self, other: T, /) -> Num[Num]: ...
        def __pow__(self, other: T, /) -> Num[Num]: ...

        def __radd__(self, other: T, /) -> Num[Num]: ...
        def __rsub__(self, other: T, /) -> Num[Num]: ...
        def __rmul__(self, other: T, /) -> Num[Num]: ...
        def __rtruediv__(self, other: T, /) -> Num[Num]: ...
        def __rfloordiv__(self, other: T, /) -> Num[Num]: ...
        def __rmod__(self, other: T, /) -> Num[Num]: ...
        def __rpow__(self, other: T, /) -> Num[Num]: ...

        def __neg__(self, /) -> Num[Num]: ...
        def __pos__(self, /) -> Num[Num]: ...
        def __abs__(self, /) -> Num[Num]: ...
        ...
        @property
        def real(self) -> Num[Num]: ...

        @property
        def imag(self) -> Num[Num]: ...
else:
