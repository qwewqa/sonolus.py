...
def main():
    ...
    if args.command == "dev" and (getattr(args, "profile", False) or getattr(args, "profile_json", None)):
        parser.error("--profile/--profile-json are not supported for 'dev'; use 'build' or 'check' instead")
